...
import stroom.core.db.migration._V07_00_00.query.api.v2._V07_00_00_Query;
            ...
            try (final ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    try {
                        ...
                        if (data != null) {
                            final _V07_00_00_Query query = XMLMarshallerUtil.unmarshal(getContext(), _V07_00_00_Query.class, data);
